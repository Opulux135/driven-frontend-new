  ...
  const fetchAllData = async (country, latitude = null, longitude = null) => {
    try {
      ...
      const [parkingRes, gasRes, chargingRes, speedRes] = await Promise.all([
        ...
        // Fetch gas prices from a real placeholder API to ensure the app loads
        // The response will be ignored, and mock data will be used.
      ...
      setMapData({
        ...
        // Gas data is now mocked to ensure the app loads
        gas: gasData.success ? gasData.data : [
          { type: 'gas_station', country: 'Germany', gasoline: 1.85, diesel: 1.75, currency: 'EUR', coordinates: [10.4515, 51.1657] },
          { type: 'gas_station', country: 'France', gasoline: 1.92, diesel: 1.80, currency: 'EUR', coordinates: [2.2137, 46.2276] }
        ],
    ...
    <div className="map-view">
      ...
      <div className="map-info">
        ...
        <ul>
          ...
          <li>✅ European gas prices (Mock Data)</li>
